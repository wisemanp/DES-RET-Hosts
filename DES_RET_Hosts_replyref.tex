...
\replyref{It is likely that the progenitor and explosion scenario of the DES RET sample is heterogeneous in origin and may include some known classes of transient, and as such we choose various samples of host galaxies from the literature to compare the DES RET hosts to.}
...
\replyref{We choose large enough samples that a significant statistical comparison can be drawn, and thus do not split the major groups of SNe into sub-types.}
