...
\newcommand{\mike}[1]{\color{green}#1 \color{black}}
\newcommand{\mat}[1]{\color{magenta}#1 \color{black}}
\newcommand{\lisa}[1]{\color{cyan}#1 \color{black}}
\newcommand{\replyanais}[1]{\color{purple}#1 \color{black}}
\newcommand{\replyravi}[1]{\color{cyan}#1 \color{black}}
\newcommand{\replydillon}[1]{\color{magenta}#1 \color{black}}
