...
To assess the distinguishing photometric properties of RETs, we take the sample of 72 \textcolor{green}{(92)} from the \citetalias{Pursiainen2018} method along with spectroscopically confirmed SNe of types Ia, Ibc, II, and SLSNe from DES that pass the following criteria:
\begin{enumerate}
...
Using the above method recovers 87 of the 92 RETs found using the \citetalias{Pursiainen2018} technique, and adds a further 14. \textcolor{green}{The five were not recovered as their GP lightcurves were fainter than the limits given above in either g or r band.}
